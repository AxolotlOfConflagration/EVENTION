      ...
      <div className="Home">
        ...
        <MyLayout>
          <Col span={15}>
            <Row>
              <EventFilters 
              category={this.state.categories} chooseCategory={this.chooseCategory} 
              city = {this.state.cities} chooseCity={this.chooseCity}
              /> 
            </Row>
            <Row>
              <br />
            ...
            <Row>
              <ShortEventList categories={this.state.categories} cities = {this.state.cities} />
            </Row>
          </Col>
          <Col span={9}>
            <EventMap />
